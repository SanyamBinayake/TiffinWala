<?php
  ...
  {
    extract($_POST);
    $insert = mysqli_query($connect,"insert into contact_db (name,email,number,address,city) values( '$name' , '$email' , '$number',    '$address'  , '$city' )") or die(mysqli_error($connect));
    if($insert)
      {
...
<div class="header">
<div class="logo">
	<h1><a href="index.html">Tiffin <span>Wala</span></a></h1>
</div>
	<div class="clear"></div>
...
<div class="section group">
				<div class="col span_2_of_3">
				  <div class="contact-form">
				  	<h2>Form for list a mess in website : </h2>
					    <form method="post">
					    	<div>
						    ...
						    <div>
						    	...
						    	<span><textarea rows="10" name="address"></textarea></span>
						    </div>
						    <div>
				...
				<div class="col span_1_of_3">
      			...
      			<div class="company_address">
				     	<h2>Developers Information :</h2>
						    	<p>The group of 4 developer develop this website.</p>
						   		<p>for give a platform to local food provider to provide food globally.</p>
						   		<p>for list a mess in website contact us or fill the form:</p>
				   		<p>Phone:7499668872</p>
				   		
				 	 	<p>Email: <a href="tiffinwala04@mail.com">tiffinWala04@gmail.com</a></p>
